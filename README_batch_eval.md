...
huggingface-cli download sartma/vr_final_models clip_seed106.pt --local-dir models/
huggingface-cli download sartma/vr_final_models best.pt --local-dir models/
huggingface-cli download sartma/vr_final_models captions_cache.json --local-dir models/
...
5. **Metrics Calculation**: Finally, it calculates Mean Average Precision (mAP), Normalized Discounted Cumulative Gain (NDCG), and Recall at K=5, 10, and 15.
